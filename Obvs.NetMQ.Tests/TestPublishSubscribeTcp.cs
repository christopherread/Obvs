...
{
    public class TestPublishSubscribeTcp
    {
        ...
        public async Task TestSendingAndReceivingStringsOverLocalHost()
        {
            ...
            IMessageSource<IMessage> source = new MessageSource<IMessage>($"tcp://localhost:43001",
            ...
            IMessagePublisher<IMessage> publisher = new MessagePublisher<IMessage>("tcp://localhost:43001",
        ...
        public async Task TestSendingAndReceivingBytesOverLocalHost()
        {
            ...
            IMessageSource<IMessage> source = new MessageSource<IMessage>("tcp://localhost:43002",
                new IMessageDeserializer<IMessage>[]
                {
            ...
            IMessagePublisher<IMessage> publisher = new MessagePublisher<IMessage>("tcp://localhost:43002",
	    ...
	    public async Task TestMessagesLongerThan32Characters()
		{
			...
			IDisposable sub;
			{
			    var source = new MessageSource<IMessage>("tcp://localhost:43003",
				    new IMessageDeserializer<IMessage>[]
				    {
		    ...
		    {
			    var publisher = new MessagePublisher<IMessage>("tcp://localhost:43003",
